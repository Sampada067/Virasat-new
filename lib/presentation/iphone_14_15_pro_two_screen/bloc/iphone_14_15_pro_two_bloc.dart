...
import 'package:virasat/presentation/iphone_14_15_pro_two_screen/models/iphone_14_15_pro_two_model.dart';
  ...
  _onInitialize(
    ...
    emit(state.copyWith(
        iphone1415ProTwoModelObj: state.iphone1415ProTwoModelObj
            ?.copyWith(widgetgridItemList: fillWidgetgridItemList())));
  }

  List<WidgetgridItemModel> fillWidgetgridItemList() {
    return [
      WidgetgridItemModel(
          whatsAppImage: ImageConstant.imgWhatsappImage20230205),
      WidgetgridItemModel(
          whatsAppImage: ImageConstant.imgWhatsappImage20230205135x143),
      WidgetgridItemModel(
          whatsAppImage: ImageConstant.imgWhatsappImage20230205135x136),
      WidgetgridItemModel(
          whatsAppImage: ImageConstant.imgWhatsappImage20230205135x137)
    ];
  }
}
